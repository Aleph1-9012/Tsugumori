...
Item {
    ...
    property color  fgColor:    Qt.rgba(232/255, 232/255, 232/255, 0.5)
    property color  fgHover:    Qt.rgba(11/255,  10/255,  9/255,  1.0)
    property color  fillColor:  Qt.rgba(232/255, 232/255, 232/255, 1.0)
    property color  borderColor: Qt.rgba(232/255, 232/255, 232/255, 0.18)
