...
Item {
    ...
    readonly property var companions: [
        ...
        {
            name:  "MAI SHIRANUI", color: "#9e1010",
    ...
    Column {
        ...
        Rectangle {
            ...
            width:   parent.width
            height:  86
            color:   Qt.rgba(10/255, 10/255, 10/255, 0.97)
            border.color: root.isReactionBubble ? "#9e1010" : Qt.rgba(200/255,184/255,154/255,0.22)
            border.width: 1
        ...
        Row {
            ...
            Rectangle {
                ...
                Text { anchors.centerIn: parent; text: "‹"; font.pixelSize: 18
                       color: maL.containsMouse ? "#e8e8e8" : Qt.rgba(200/255,184/255,154/255,0.35)
            ...
            Rectangle {
                ...
                anchors.verticalCenter: parent.verticalCenter
                Text { anchors.centerIn: parent; text: "›"; font.pixelSize: 18
                       color: maR.containsMouse ? "#e8e8e8" : Qt.rgba(200/255,184/255,154/255,0.35)
                       Behavior on color { ColorAnimation { duration: 100 } } }
        ...
        Row {
            ...
            Repeater {
                ...
                Rectangle {
                    width: 5; height: 5
                    color: index === root.currentIdx ? "#e8e8e8" : Qt.rgba(200/255,184/255,154/255,0.15)
                    Behavior on color { ColorAnimation { duration: 100 } }
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    color: index < recentCount
                        ? (recentCount >= root.spamCount-1 ? "#c87060" : "#9e1010")
