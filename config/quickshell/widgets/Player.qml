            ...
            Column {
                ...
                Rectangle {
                    ...
                    gradient: Gradient {
                        ...
                        GradientStop { position: 0.2; color: Qt.rgba(204/255,21/255,21/255,0.5) }
                        GradientStop { position: 0.8; color: Qt.rgba(204/255,21/255,21/255,0.5) }
                ...
                Item {
                    ...
                    Text {
                        ...
                        color: Qt.rgba(204/255,21/255,21/255,0.2)
                        y: 3
                    ...
                    Rectangle {
                        ...
                        color: Qt.rgba(204/255,21/255,21/255,0.06)
                    }
                }
                ...
                Item {
                    ...
                    Rectangle {
                        anchors.bottom: parent.bottom
                        width: parent.width; height: 1
                        color: Qt.rgba(204/255,21/255,21/255,0.07)
                    }
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            color: Qt.rgba(204/255,21/255,21/255,0.1)
                        }
                    }
                    ...
                    Item {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                color: Qt.rgba(204/255,21/255,21/255,0.9)
                            ...
                            Text {
                                ...
                                font.pixelSize: 7
                                font.letterSpacing: 1
                                color: Qt.rgba(204/255,21/255,21/255,0.42)
                                elide: Text.ElideRight
                            }
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        border.color: index < 2
                                            ...
                                            : Qt.rgba(204/255,21/255,21/255,0.14)
                                        Text {
                                            id: tagTxt
        ...
        z: 20
                ...
                Column {
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            color: Qt.rgba(204/255,21/255,21/255,0.08)
                        }
                        // Fill
                        Rectangle {
                            anchors { verticalCenter: parent.verticalCenter; left: parent.left }
                            height: 2
                            color:  Qt.rgba(204/255,21/255,21/255,0.6)
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        width: parent.width; height: 1
                        color: Qt.rgba(204/255,21/255,21/255,0.05)
                    }
    ...
    component CBtn: Item {
        ...
        Rectangle {
            ...
            border.color: parent.isPlay
                ? Qt.rgba(204/255,21/255,21/255,0.3)
                : Qt.rgba(204/255,21/255,21/255,0.1)
        ...
        property color textColor: cbMa.containsMouse
            ...
            : (isPlay
                ...
                : Qt.rgba(204/255,21/255,21/255,0.38))
